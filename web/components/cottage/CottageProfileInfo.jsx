              ...
              <>
                <Grid item xs={3}>
                  <Card style={{ padding: 30 }}>
                    <Typography key={room.id} variant="h5" fontWeight="fontWeightMedium" component="div" sx={{ mb: 2 }}>
                      Bedroom {index + 1}
                    </Typography>
                    {[...Array(room.numberOfBeds).keys()].map((i) => (
                      <Bed fontSize="large" key={i} />
                    ))}
                    <Typography key={room.id} variant="h5" fontWeight="fontWeightLight" component="div" sx={{ mt: 1 }}>
